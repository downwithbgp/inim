...
- **Five reviewed case studies** under `case-studies/`:
  ...
  - `case-studies/inc0303298-noaa` — fresh NOAA I2 participant event
    (INC0303298) with a no-route-state-change result across 284
    qualifying observer-prefix streams.
